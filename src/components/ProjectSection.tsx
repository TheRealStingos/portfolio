...
export default function ProjectsSection() {
    return(
        <section id="projectsSection" className="flex flex-col m-24">
            <Project screenshot={jumble} title="Jubmle" description="All in One Media Logging Social Media App! Log, rate, and review your favorite movies, video games, music, and books. Compare with your friends! *Under Construction*"
