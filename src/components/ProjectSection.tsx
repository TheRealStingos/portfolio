...
import jumble from "../assets/jumbleScreen.png"

export default function ProjectsSection() {
    return(
        <section id="projectsSection" className="flex flex-col m-24">
            <Project screenshot={jumble} title="Jumble" description="All in One Media Logging Social Media App! Log, rate, and review your favorite movies, video games, music, and books. Compare with your friends! *Under Construction*" repo="https://github.com/TheRealStingos/jumble" demo="https://jumble.justinmoore.dev"/>
